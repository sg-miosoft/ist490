...
?> 
			...
			<div class="add-form-contain">
				<form class="add-device-form" action="update_network.php" method="post">
				<span class="align-form-text-name">Network Name </span><input type="text" class="addURL" placeholder="DMZ Zone" name="Answer" size=50 value="<?php echo $row['network_name'];?>"><span class="required-text">REQUIRED</span><p></p>
